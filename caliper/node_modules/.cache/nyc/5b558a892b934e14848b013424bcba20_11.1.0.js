 ...
 */class FixedRate extends RateInterface{/**
     ...
     */constructor(blockchain,opts){cov_dwrbur4jp.f[0]++;cov_dwrbur4jp.s[2]++;super(blockchain,opts);}/**
     * Initialise the rate controller with a passed msg object
     * @param {JSON} msg the initialisation message
     */init(msg){cov_dwrbur4jp.f[1]++;// Use the passed tps option
let tps=(cov_dwrbur4jp.s[3]++,this.options.tps);let tpsPerClient=(cov_dwrbur4jp.s[4]++,msg.totalClients?(cov_dwrbur4jp.b[0][0]++,tps/msg.totalClients):(cov_dwrbur4jp.b[0][1]++,tps));cov_dwrbur4jp.s[5]++;this.sleepTime=tpsPerClient>0?(cov_dwrbur4jp.b[1][0]++,1000/tpsPerClient):(cov_dwrbur4jp.b[1][1]++,0);}/**
    ...
    */applyRateControl(start,idx,currentResults){cov_dwrbur4jp.f[2]++;cov_dwrbur4jp.s[6]++;if(this.sleepTime===0){cov_dwrbur4jp.b[2][0]++;cov_dwrbur4jp.s[7]++;return Promise.resolve();}else{cov_dwrbur4jp.b[2][1]++;}let diff=(cov_dwrbur4jp.s[8]++,this.sleepTime*idx-(Date.now()-start));cov_dwrbur4jp.s[9]++;if(diff>5){cov_dwrbur4jp.b[3][0]++;cov_dwrbur4jp.s[10]++;return Sleep(diff);}else{cov_dwrbur4jp.b[3][1]++;cov_dwrbur4jp.s[11]++;return Promise.resolve();}}}cov_dwrbur4jp.s[12]++;module.exports=FixedRate;